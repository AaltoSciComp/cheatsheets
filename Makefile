...
cs:
	$(NUP) "CSIT Cheatsheet.pdf" 1-2 --outfile cs-cheatsheet.pdf
sci:
	$(NUP)  "Science-IT Cheatsheet - Data Management.pdf" --outfile sci-data-cheatsheet.pdf
cssci:
	$(NUP)  "CSIT Cheatsheet.pdf" 1-2 "Science-IT Cheatsheet - Data Management.pdf" --outfile cs-sci-cheatsheet.pdf

triton:
	$(NUP) Triton\ Cheatsheet.pdf 1-4 --outfile triton-cheatsheet.pdf
ipr:
	$(NUP) IPR\ Cheatsheet.pdf 1-2 --outfile ipr-cheatsheet.pdf
...
#	pdftk C=CSITCheatsheet.pdf T=TritonCheatsheet.pdf G=git-cheatsheet-page01.pdf D=Science-ITCheatsheet-DataManagement.pdf cat C1 T1 G1 D1 output _coverB.pdf
	...
	pdfjam "CSIT Cheatsheet.pdf" 1 "Triton Cheatsheet.pdf" 1 _coverA.pdf 1 "Science-IT Cheatsheet - Data Management.pdf" 1  --nup 2x2 --no-landscape -o _coverB.pdf
	$(NUP) 'Cheatsheet cover.pdf' _coverB.pdf -o cover.pdf
